    ...
    <div className="mb-8">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            href={`/dashboard/trips/${trip.id}/members`}
            className="text-camp-earth hover:text-white text-sm font-medium py-2 px-3 rounded-lg hover:bg-white/10 transition-colors flex items-center gap-1.5"
          >
            <svg
              className="w-3.5 h-3.5"
              fill="none"
