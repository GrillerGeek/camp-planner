    ...
    <div className="min-h-screen bg-camp-night flex items-center justify-center px-4">
      <div className="max-w-sm w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Camp Planner</h1>
          <p className="text-camp-earth text-sm">
            Plan trips, pack smart, eat well.
          </p>
        </div>

        {error && (
          <div className="bg-red-900/30 border border-red-500/50 text-red-200 px-4 py-3 rounded-lg mb-6 text-sm text-center">
